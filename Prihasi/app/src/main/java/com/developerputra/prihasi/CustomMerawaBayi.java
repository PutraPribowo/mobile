...
public class CustomMerawaBayi extends RecyclerView.Adapter<CustomMerawaBayi.MyViewHolder> {
    ...
    public CustomMerawaBayi(ArrayList<InfolearningModel> data) {
        this.dataSet = data;
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_merawat_bayi, parent, false);
