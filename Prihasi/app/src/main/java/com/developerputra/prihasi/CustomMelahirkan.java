...
public class CustomMelahirkan extends RecyclerView.Adapter<CustomMelahirkan.MyViewHolder> {
    ...
    public CustomMelahirkan(ArrayList<InfolearningModel> data) {
        this.dataSet = data;
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_melahirkan, parent, false);
