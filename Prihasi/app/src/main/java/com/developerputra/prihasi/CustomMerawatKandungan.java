...
public class CustomMerawatKandungan extends RecyclerView.Adapter<CustomMerawatKandungan.MyViewHolder> {
    ...
    public CustomMerawatKandungan(ArrayList<InfolearningModel> data) {
        this.dataSet = data;
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_merawat_kandungan, parent, false);
