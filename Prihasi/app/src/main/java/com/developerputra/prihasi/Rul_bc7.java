...
public class Rul_bc7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rul_bc7);
        ...
        Jawab = (Button)findViewById(R.id.jawabab010);

        Jawab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent zz18 = new Intent(Rul_bc7.this,Konsultasi.class);
                startActivity(zz18);
            }
        });
    }

    public void btnClickdp12(View v) {
        int jmlh = 1 + 2;
        int gejala = 0 + 2;
        tifoid1 = (CheckBox) findViewById(R.id.kel28);
        tvHasil = (TextView) findViewById(R.id.hoo);
