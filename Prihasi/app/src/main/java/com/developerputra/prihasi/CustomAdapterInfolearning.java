...
public class CustomAdapterInfolearning extends RecyclerView.Adapter<CustomAdapterInfolearning.MyViewHolder> {
    ...
    public CustomAdapterInfolearning(ArrayList<InfolearningModel> data) {
        this.dataSet = data;
    }
