...
public class Rul_bc4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rul_bc4);
        ...
        Jawab = (Button)findViewById(R.id.jawabab07);

        Jawab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent zz15 = new Intent(Rul_bc4.this,Konsultasi.class);
                startActivity(zz15);
            }
        });
    }

    public void btnClickd12233(View v) {
        int jmlh = 1 + 2;
        int gejala = 0 + 2;
        tifoid1 = (CheckBox) findViewById(R.id.kel6);
        tvHasil = (TextView) findViewById(R.id.hehe999);
